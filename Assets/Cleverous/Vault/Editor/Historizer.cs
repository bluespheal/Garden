...
namespace Cleverous.VaultDashboard
{
    public class Historizer : VisualElement
    {
        ...
        private void AddAndHistorize()
        {
            ...
            if (m_history.Count > 0 && m_history.Last() == VaultDashboard.CurrentAsset) return;
            if (m_history.Contains(VaultDashboard.CurrentAsset)) return;

            m_history.Add(VaultDashboard.CurrentAsset);
        ...
        private void RestoreHistory()
        {
            ...
            foreach (string guid in split)
            {
                ...
                m_history.Add(AssetDatabase.LoadAssetAtPath<DataEntity>(AssetDatabase.GUIDToAssetPath(guid)));
            }
        }
        ...
        public void GoToHistoryIndex(int index)
        {
            ...
            VaultDashboard.InspectAssetRemote(m_history[index], m_history[index].GetType());
        }
    }
}